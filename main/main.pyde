...
def setup():
    ...
    spacebar_list.append([resource.spacebar, width*0.5, height*0.1, 60, 40])
...
def draw():
    GuardDebug()
    clear()
    global grow_height, grow_speed, grow_time, prev_time, flower_list, flower, flower_per_size, space_per_size
    ...
    if grow_height < PHASE_1:
        ...
        graphic.draw_static_objects(spacebar_list, space_per_size, flower_anchor)
        pass
